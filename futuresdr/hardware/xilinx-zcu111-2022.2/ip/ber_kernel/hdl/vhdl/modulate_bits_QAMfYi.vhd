...
entity modulate_bits_QAMfYi_rom is 
    generic(
             dwidth     : integer := 15; 
             awidth     : integer := 4; 
             mem_size    : integer := 16
...
architecture rtl of modulate_bits_QAMfYi_rom is 
...
entity modulate_bits_QAMfYi is
    generic (
...
architecture arch of modulate_bits_QAMfYi is
    component modulate_bits_QAMfYi_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    modulate_bits_QAMfYi_rom_U :  component modulate_bits_QAMfYi_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
