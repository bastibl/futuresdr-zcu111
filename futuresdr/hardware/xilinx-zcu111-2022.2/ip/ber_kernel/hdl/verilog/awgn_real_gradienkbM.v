...
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module awgn_real_gradienkbM_rom (
...
initial begin
    $readmemh("./awgn_real_gradienkbM_rom.dat", ram0);
    $readmemh("./awgn_real_gradienkbM_rom.dat", ram1);
end
...
awgn_real_gradienkbM_rom awgn_real_gradienkbM_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
