...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "C_S_AXIS_TKEEP_WIDTH" -parent ${Page_0}
...
proc update_PARAM_VALUE.C_S_AXIS_TKEEP_WIDTH { PARAM_VALUE.C_S_AXIS_TKEEP_WIDTH } {
	# Procedure called to update C_S_AXIS_TKEEP_WIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_S_AXIS_TKEEP_WIDTH { PARAM_VALUE.C_S_AXIS_TKEEP_WIDTH } {
	# Procedure called to validate C_S_AXIS_TKEEP_WIDTH
	return true
}
...
proc update_MODELPARAM_VALUE.C_S_AXIS_TKEEP_WIDTH { MODELPARAM_VALUE.C_S_AXIS_TKEEP_WIDTH PARAM_VALUE.C_S_AXIS_TKEEP_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_S_AXIS_TKEEP_WIDTH}] ${MODELPARAM_VALUE.C_S_AXIS_TKEEP_WIDTH}
}
