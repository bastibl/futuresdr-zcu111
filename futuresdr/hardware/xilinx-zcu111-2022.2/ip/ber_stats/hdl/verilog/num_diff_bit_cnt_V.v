...
`timescale 1 ns / 1 ps
(* rom_style = "block" *) module num_diff_bit_cnt_V_rom (
...
initial begin
    $readmemh("./num_diff_bit_cnt_V_rom.dat", ram0);
    $readmemh("./num_diff_bit_cnt_V_rom.dat", ram1);
end
...
num_diff_bit_cnt_V_rom num_diff_bit_cnt_V_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
