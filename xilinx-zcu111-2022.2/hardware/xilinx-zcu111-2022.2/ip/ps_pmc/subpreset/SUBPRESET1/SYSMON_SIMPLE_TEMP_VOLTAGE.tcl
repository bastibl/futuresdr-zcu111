proc getPresetInfo {} {
  ...
  set infoMsg "Enabling temperature and voltage monitoring. The preset will enable device temperature and over temperature monitoring along with  on-chip supply ($presetMeas) monitoring . Please make sure default threshold values are appropriate to your design. "
  return [dict create name {simple_temperature_voltage_monitoring} description {Enables temperature and voltage monitoring}  vlnv xilinx.com:ip:ps_pmc:1.0 display_name {Simple Temperature And Voltage Monitoring} info_msg $infoMsg]
}
