...
`timescale 1 ns / 1 ps
(* rom_style = "distributed" *) module calc_llr_demod_RErcU_rom (
...
initial begin
    $readmemh("./calc_llr_demod_RErcU_rom.dat", ram0);
    $readmemh("./calc_llr_demod_RErcU_rom.dat", ram1);
end
...
calc_llr_demod_RErcU_rom calc_llr_demod_RErcU_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
