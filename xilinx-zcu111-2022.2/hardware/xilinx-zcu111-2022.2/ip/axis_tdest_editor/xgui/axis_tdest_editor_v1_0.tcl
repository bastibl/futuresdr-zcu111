...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "C_TDEST_VAL" -parent ${Page_0}
...
proc update_PARAM_VALUE.C_TDEST_VAL { PARAM_VALUE.C_TDEST_VAL } {
	# Procedure called to update C_TDEST_VAL when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_TDEST_VAL { PARAM_VALUE.C_TDEST_VAL } {
	# Procedure called to validate C_TDEST_VAL
	return true
}
...
proc update_MODELPARAM_VALUE.C_TDEST_VAL { MODELPARAM_VALUE.C_TDEST_VAL PARAM_VALUE.C_TDEST_VAL } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_TDEST_VAL}] ${MODELPARAM_VALUE.C_TDEST_VAL}
}
