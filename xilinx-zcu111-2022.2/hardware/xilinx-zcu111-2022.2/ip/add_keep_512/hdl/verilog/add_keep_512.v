...
(* CORE_GENERATION_INFO="add_keep_512,hls_ip_2018_1_0,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xczu9eg-ffvb1156-2L-e,HLS_INPUT_CLOCK=2.500000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=0.424000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=2402,HLS_SYN_LUT=351}" *)
...
input   ap_clk;
input   ap_rst_n;
input  [63:0] ctrl_V_V_TDATA;
input   ctrl_V_V_TVALID;
output   ctrl_V_V_TREADY;
input  [511:0] din_TDATA;
input   din_TVALID;
output   din_TREADY;
input  [0:0] din_TLAST;
output  [511:0] dout_TDATA;
output   dout_TVALID;
input   dout_TREADY;
output  [63:0] dout_TKEEP;
output  [0:0] dout_TLAST;

reg    ap_rst_n_inv;
reg   [63:0] ctrl_V_V_0_data_out;
wire    ctrl_V_V_0_vld_in;
wire    ctrl_V_V_0_vld_out;
wire    ctrl_V_V_0_ack_in;
reg    ctrl_V_V_0_ack_out;
reg   [63:0] ctrl_V_V_0_payload_A;
reg   [63:0] ctrl_V_V_0_payload_B;
...
reg   [63:0] tmp_V_reg_95;
reg    ap_block_state3_pp0_stage0_iter0;
wire    ap_block_state4_pp0_stage0_iter1;
reg    ap_block_pp0_stage0_11001;
wire   [0:0] tmp_last_V_fu_82_p1;
wire   [63:0] data_out_keep_V_fu_87_p3;
...
assign data_out_keep_V_fu_87_p3 = ((din_V_last_V_0_data_out[0:0] === 1'b1) ? tmp_V_reg_95 : 64'd65535);
