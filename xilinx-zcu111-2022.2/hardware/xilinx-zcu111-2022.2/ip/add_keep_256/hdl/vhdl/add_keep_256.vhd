...
entity add_keep_256 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst_n : IN STD_LOGIC;
    ctrl_V_V_TDATA : IN STD_LOGIC_VECTOR (31 downto 0);
    ...
    dout_TDATA : OUT STD_LOGIC_VECTOR (255 downto 0);
    dout_TVALID : OUT STD_LOGIC;
    dout_TREADY : IN STD_LOGIC;
    dout_TKEEP : OUT STD_LOGIC_VECTOR (31 downto 0);
    dout_TLAST : OUT STD_LOGIC_VECTOR (0 downto 0) );
end;


architecture behav of add_keep_256 is 
    attribute CORE_GENERATION_INFO : STRING;
    attribute CORE_GENERATION_INFO of behav : architecture is
    "add_keep_256,hls_ip_2018_1_0,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xczu9eg-ffvb1156-2L-e,HLS_INPUT_CLOCK=2.500000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=0.449000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=1218,HLS_SYN_LUT=319}";
    ...
    signal ctrl_V_V_0_data_out : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal ctrl_V_V_0_payload_A : STD_LOGIC_VECTOR (31 downto 0);
    signal ctrl_V_V_0_payload_B : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal din_V_data_V_0_data_out : STD_LOGIC_VECTOR (255 downto 0);
    ...
    signal din_V_data_V_0_payload_A : STD_LOGIC_VECTOR (255 downto 0);
    signal din_V_data_V_0_payload_B : STD_LOGIC_VECTOR (255 downto 0);
    ...
    signal dout_V_data_V_1_data_out : STD_LOGIC_VECTOR (255 downto 0);
    ...
    signal dout_V_data_V_1_payload_A : STD_LOGIC_VECTOR (255 downto 0);
    signal dout_V_data_V_1_payload_B : STD_LOGIC_VECTOR (255 downto 0);
    ...
    signal dout_V_keep_V_1_data_out : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal dout_V_keep_V_1_payload_A : STD_LOGIC_VECTOR (31 downto 0);
    signal dout_V_keep_V_1_payload_B : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal tmp_V_reg_95 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_block_state3_pp0_stage0_iter0 : BOOLEAN;
    signal ap_block_state4_pp0_stage0_iter1 : BOOLEAN;
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal tmp_last_V_fu_82_p1 : STD_LOGIC_VECTOR (0 downto 0);
    signal data_out_keep_V_fu_87_p3 : STD_LOGIC_VECTOR (31 downto 0);
