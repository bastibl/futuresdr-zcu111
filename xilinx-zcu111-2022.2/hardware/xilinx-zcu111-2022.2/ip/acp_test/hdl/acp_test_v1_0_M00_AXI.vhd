...
entity acp_test_v1_0_M00_AXI is
	generic (
	...
	port (
		...
		INIT_AXI_step	: in std_logic;
		
		AXI_Read       : in std_logic;
		
		AXI_Write      : in std_logic;  
		
		AXI_WRITE_DATA : in std_logic_vector(127 downto 0);
    ...
    -- accept the read data and response information.
		...
		AXI_ADDR        : in std_logic_vector(C_M_AXI_ADDR_WIDTH-1 downto 0);
        state_axi       : out std_logic_vector( 1 downto 0)
	);
end acp_test_v1_0_M00_AXI;

architecture implementation of acp_test_v1_0_M00_AXI is
	...
	-- Example State machine to initialize counter, initialize write transactions, 
	 ...
	 type state is ( IDLE, -- This state initiates AXI4Lite transaction  
	 				...
	 				WAIT_STATE);-- This state issues the status of comparison 
    ...
    signal init_transaction : std_logic;
...
begin
	...
	M_AXI_WDATA	<= AXI_WRITE_DATA;--x"0000000012345678FFFFFFFFDEADBEEF";
	...
	-- a parameterized threshold
	 ...
	 -- against the number of burst transactions the master needs to initiate                                    
	        ...
	        case (mst_exec_state) is                                                                             
	           ...
	           when IDLE =>                                                                              
	             ...
	             -- AXI transaction when init_txn_pulse is asserted 
	               if ( INIT_AXI_step = '1') then  
	                   if( AXI_Read = '1') then
	                        mst_exec_state  <= INIT_READ;
	                   elsif( AXI_Write = '1') then
	  ...
	  state_axi <= "00" when (mst_exec_state = IDLE) ELSE
	               "01" when (mst_exec_state = INIT_READ) ELSE
	               "10" when (mst_exec_state = INIT_WRITE) ELSE
	               "11";
