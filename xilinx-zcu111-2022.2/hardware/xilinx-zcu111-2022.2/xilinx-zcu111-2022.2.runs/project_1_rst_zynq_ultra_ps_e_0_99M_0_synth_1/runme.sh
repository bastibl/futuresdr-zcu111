...
HD_PWD='/tmp/tmp.rJl7ZfSWDC/temp/hwflow/hwflow_project_1/project_1.runs/project_1_rst_zynq_ultra_ps_e_0_99M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log project_1_rst_zynq_ultra_ps_e_0_99M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source project_1_rst_zynq_ultra_ps_e_0_99M_0.tcl
