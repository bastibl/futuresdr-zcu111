...
# Import SDFEC definition
import_files -fileset sources_1 ${src_repo_path}/all_code_def.txt
...
##################################################################
  ...
  set rst_zynq_ultra_ps_e_0_99M [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset: rst_zynq_ultra_ps_e_0_99M ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.LDPC_Decode_Code_Definition ../../../../../../${proj_name}.srcs/sources_1/imports/src/all_code_def.txt \
  ...
  set_property -dict [ list \
   ...
   CONFIG.LDPC_Encode_Code_Definition ../../../../../../${proj_name}.srcs/sources_1/imports/src/all_code_def.txt \
...
# Create instance: zynq_ultra_ps_e_0, and set properties
  ...
  set zynq_ultra_ps_e_0_axi_periph [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect: zynq_ultra_ps_e_0_axi_periph ]
  set_property -dict [ list \
   ...
   CONFIG.NUM_MI {11} \
 ] [set zynq_ultra_ps_e_0_axi_periph]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets src_data_broadcast_M00_AXIS] [get_bd_intf_pins enc_ip_probe/mon] [get_bd_intf_pins src_data_broadcast/M00_AXIS]
  ...
  connect_bd_net -net rst_zynq_ultra_ps_e_0_99M_peripheral_aresetn [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/M02_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins dac_source_i/s_axi_aresetn] [get_bd_pins rst_zynq_ultra_ps_e_0_99M/peripheral_aresetn] [get_bd_pins usp_rf_data_converter_0_i/s_axi_aresetn] [get_bd_pins zynq_ultra_ps_e_0_axi_periph/S00_ARESETN]
  ...
  connect_bd_net [get_bd_pins adc_sink_i/s_axi_aresetn] [get_bd_pins rst_zynq_ultra_ps_e_0_99M/peripheral_aresetn]
